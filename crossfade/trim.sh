...
ffmpeg -i "${FILENAME_ONLY}.${EXT_ONLY}" -map 0 -c copy -t "$OUTPUT_DURATION" "${FILENAME_ONLY}a.${EXT_ONLY}"
ffmpeg -i "${FILENAME_ONLY}.${EXT_ONLY}" -map 0 -c copy -ss "$OUTPUT_DURATION" "${FILENAME_ONLY}b.${EXT_ONLY}"
